...
depth:"Bentham founded it; Mill refined it. Bentham counted pleasures equally. Mill argued intellectual pleasures rank higher. Both: morality is about outcomes, not intentions.",
dist:"Unlike deontology (rules) and virtue ethics (character), utilitarianism ONLY cares about consequences. A lie that saves lives is good. Truth that causes suffering is bad.",
hook:"A happiness calculator — every action scored by total well-being across everyone affected.",
trap:"Students confuse it with selfishness. It's the opposite — count everyone equally, including strangers.",
kw:["consequences","greatest good","Bentham","Mill"],conn:["actrule","expmachine"],
dil:{t:"A factory causes minor pollution but provides 500 jobs. What framework applies?",
  o:[{t:"Calculate total harm vs benefit for ALL parties.",f:"Utilitarian",w:"Demands weighing all consequences."},
    {t:"Pollution violates residents' rights regardless of jobs.",f:"Deontological",w:"People shouldn't be harmed as means to economic benefit."},
    {t:"A good leader finds ways to reduce harm while preserving jobs.",f:"Virtue Ethics",w:"Practical wisdom over false dilemmas."}]},
tf:[{c:"Utilitarianism judges actions by outcomes, not intentions.",a:true,e:"Correct — only consequences matter."},{c:"Utilitarianism says maximize YOUR OWN happiness.",a:false,e:"False — equal consideration of EVERYONE."}],
mc:[{q:"A city builds a park (10,000 benefit slightly) or hospital (saves 100). A utilitarian:",o:["Always hospital","Always park","Calculate total well-being","Ask what's fair"],c:2,e:"Must calculate actual impact."},
  {q:"What distinguishes Mill from Bentham?",o:["Mill rejected utilitarianism","Mill argued some pleasures are qualitatively higher","Mill focused on rules","Mill was a deontologist"],c:1,e:"Mill: 'Better Socrates dissatisfied than a fool satisfied.'"},
  {q:"Strongest objection to utilitarianism:",o:["It's too old","Could justify harming minorities for majority","Too simple","Bentham was wrong"],c:1,e:"If 51% benefit from oppressing 49%, utilitarianism struggles."}]},
...
dist:"Some acts are inherently wrong — lying, murder, using people — EVEN if they produce good outcomes.",
hook:"'Deon' = duty. A judge following law even when the verdict seems unfair.",
trap:"Students think it means 'follow existing rules.' Kant meant rules from REASON, not convention.",
kw:["duty","rules","Kant","universal law"],conn:["catimperative","naturallaw"],
dil:{t:"A murderer asks where your friend is hiding. Lie to save them, or tell truth?",
  o:[{t:"Lie — saving a life matters more.",f:"Utilitarian",w:"Consequences override rules when lives are at stake."},
    {t:"Tell truth — you're responsible for lying, not what the murderer does.",f:"Kant's position",w:"Moral duty doesn't bend."},
    {t:"Find a creative way to redirect without lying.",f:"Virtue Ethics",w:"Practical wisdom preserves both values."}]},
tf:[{c:"Kant believed consequences determine moral worth.",a:false,e:"False — duty and principle determine morality."},{c:"Deontology holds some acts are wrong even with good outcomes.",a:true,e:"Lying and murder are wrong regardless."}],
mc:[{q:"Kant's key moral test:",o:["Does it make people happy?","Could everyone do this without contradiction?","Does it build character?","Is it legal?"],c:1,e:"Universalizability: if everyone did it and it failed, it's wrong."},
  {q:"About torturing one to save thousands:",o:["Do it","Never — violates dignity","Only with consent","Depends"],c:1,e:"Deontology prohibits using people as means — absolutely."},
  {q:"Main weakness of deontology:",o:["Too new","Can seem rigid when rules lead to terrible outcomes","No rules","Kant unpopular"],c:1,e:"Rigid rule-following can produce morally questionable results."}]},
...
depth:"Aristotle: become virtuous by practicing virtue — like learning music. Character over calculation.",
dist:"Utilitarianism: 'Best outcome?' Deontology: 'What rule?' Virtue: 'What would a good person do?'",
hook:"Learning guitar — not by rules but by practicing until excellence is habitual.",
trap:"Students think it's vague. Aristotle was precise — specific virtues with clear excesses and deficiencies.",
kw:["character","Aristotle","habit","flourishing"],conn:["mean"],
dil:{t:"A colleague takes credit for a junior's idea in a meeting. What do you do?",
  o:[{t:"Speak up if it helps the team overall.",f:"Utilitarian",w:"Calculate net benefit."},
    {t:"Speak up — dishonesty is wrong regardless.",f:"Deontological",w:"Proper credit is a duty."},
    {t:"Ask what a person of integrity would do HERE.",f:"Virtue Ethics",w:"Focus on what character you're building."}]},
tf:[{c:"Virtue ethics focuses on character rather than rules or consequences.",a:true,e:"'What kind of person should I be?'"},{c:"Aristotle believed virtues are innate.",a:false,e:"Virtues are HABITS developed through practice."}],
mc:[{q:"What distinguishes virtue ethics from deontology?",o:["Same thing","Virtue=character, deontology=rules","Virtue has no principles","Deontology=character"],c:1,e:"Fundamentally different starting points."},
  {q:"How do we become virtuous?",o:["Reading","Being born virtuous","Repeatedly practicing virtuous actions","Following rules"],c:2,e:"Like music — practice makes it habitual."},
  {q:"Virtue ethics handles dilemmas by asking:",o:["Max happiness?","What's the rule?","What would a person of good character do?","What's legal?"],c:2,e:"Character-based reasoning."}]},
...
dist:"'Categorical' = unconditional, always applies. Unlike 'hypothetical' which only applies if you want something.",
hook:"Two tests: (1) Universal law? (2) Using someone as a tool?",
trap:"Not 'follow the law' — moral principles from reason.",
kw:["Kant","universal law","humanity","ends"],conn:["deont"],
dil:{t:"You could cheat on a test and nobody would know. Apply the categorical imperative.",
  o:[{t:"If everyone cheated, grades become meaningless — contradiction.",f:"Universal Law",w:"Universalized cheating destroys testing."},
    {t:"Cheating uses honest students as means to your advantage.",f:"Humanity",w:"Exploiting integrity violates dignity."},
    {t:"No one's harmed, so it's fine.",f:"Utilitarian objection",w:"What Kant REJECTS."}]},
tf:[{c:"The categorical imperative applies unconditionally.",a:true,e:"Always, everyone, no exceptions."},{c:"Treat people as ends, never merely as means.",a:true,e:"People have dignity, not just price."}],
mc:[{q:"Lying fails the categorical imperative because:",o:["Doesn't maximize happiness","If everyone lied, trust collapses","Not a virtue","Illegal"],c:1,e:"Universal lying destroys trust."},
  {q:"Formula of Humanity prohibits:",o:["All interaction","Using people merely as tools","Having goals","Success"],c:1,e:"Treat people as ends, not instruments."},
  {q:"Treating someone merely as a means:",o:["Paying fairly","Lying to get what you want","Having friends","Teaching"],c:1,e:"Deception uses trust as a tool."}]},
...
depth:"If pleasure were everything, everyone would choose the machine. Refusal shows we value authenticity.",
dist:"Strongest objection to hedonistic utilitarianism — good life requires more than feeling good.",
hook:"Neo choosing the red pill. Real world > perfect simulation.",
trap:"Doesn't disprove ALL utilitarianism — challenges hedonistic specifically.",
kw:["Nozick","pleasure","reality","authenticity"],conn:["util"],
dil:{t:"The experience machine exists and is safe. Do you plug in?",
  o:[{t:"Yes — if experiences feel real, no difference.",f:"Hedonist",w:"Simulated pleasure = real pleasure if indistinguishable."},
    {t:"No — I want to actually DO things.",f:"Nozick's insight",w:"We value being and doing, not just experiencing."},
    {t:"No — real relationships need real people.",f:"Relational",w:"Simulated love isn't love."}]},
tf:[{c:"Most people choose to plug in.",a:false,e:"Most REFUSE — pleasure isn't everything."},{c:"The machine challenges hedonistic utilitarianism.",a:true,e:"If pleasure = only good, everyone would choose machine."}],
mc:[{q:"Experience machine demonstrates:",o:["Tech bad","People value things beyond pleasure","Utilitarianism completely wrong","Kant right"],c:1,e:"Authenticity, achievement, connection > just feeling."},
  {q:"A preference utilitarian responds:",o:["Plug in","People's PREFERENCE for reality matters","Nozick wrong","Ignore it"],c:1,e:"Preference utilitarianism counts what people want, not just pleasure."}]},

{id:"relativism",name:"Moral Relativism",cat:"Metaethics",
core:"No universal moral truths — right and wrong set by culture or individual.",
depth:"Seems tolerant, but implies you can never condemn another culture, including slavery.",
dist:"Denies what every other theory assumes — that objective moral truth exists.",
hook:"'When in Rome' to its extreme — but if Rome has slavery, should you?",
trap:"Confusing relativism with tolerance. Tolerance requires believing others WRONG but respecting them.",
kw:["culture","relative","universal","tolerance"],conn:["naturallaw"],
dil:{t:"Culture A practices child marriage. Culture B condemns it. A relativist says:",
  o:[{t:"Culture A is wrong — harming children is wrong everywhere.",f:"Objectivism",w:"Requires universal truths — contradicts relativism."},
    {t:"Neither is objectively right — morality is cultural.",f:"Consistent relativism",w:"Logical but most find it unacceptable."},
    {t:"We can criticize measurable harm while respecting differences.",f:"Moderate",w:"Balances sensitivity and standards."}]},
tf:[{c:"Moral relativism claims some truths are universal.",a:false,e:"DENIES all universal moral truths."},{c:"If relativism is true, we cannot condemn genocide.",a:true,e:"Most devastating objection."}],
mc:[{q:"Strongest objection to relativism:",o:["Complicated","Impossible to condemn slavery/genocide","Too new","Contradicts religion"],c:1,e:"Can NEVER say another culture is wrong."},
  {q:"Difference between relativism and tolerance:",o:["Identical","Tolerance='wrong but respected'; relativism=nothing is wrong","Tolerance stricter","Relativism requires tolerance"],c:1,e:"True tolerance needs 'wrong' — relativism eliminates it."}]},

{id:"socialcontract",name:"Social Contract",cat:"Political Philosophy",
core:"Rules justified because rational people would agree under fair conditions.",
depth:"Hobbes: escape chaos. Rawls: 'veil of ignorance' — design rules not knowing your position.",
dist:"Grounds morality in agreement — rules legitimate because we'd consent.",
hook:"Board game rules without knowing which piece you'll be.",
trap:"The contract is hypothetical — no one actually signed it.",
kw:["Hobbes","Rawls","veil of ignorance","fairness"],conn:["deont"],
dil:{t:"Behind the veil of ignorance, design healthcare. You don't know if you'll be rich or poor.",
  o:[{t:"Universal healthcare — I might be poor.",f:"Rawlsian",w:"Not knowing forces protecting worst-off."},
    {t:"Market-based — competition produces quality.",f:"Libertarian",w:"Rawls may bias toward redistribution."},
    {t:"Basic coverage + optional private.",f:"Compromise",w:"Balances fairness and freedom."}]},
tf:[{c:"Social contract grounds morality in rational agreement.",a:true,e:"Legitimate because rational people would consent."},{c:"Rawls's veil means actually forgetting memories.",a:false,e:"Thought experiment — imagine not knowing position."}],
mc:[{q:"Veil of ignorance ensures fair rules because:",o:["Everyone smart","Design without knowing position","Eliminates disagreement","Rawls always right"],c:1,e:"Might be anyone, so protect everyone."},
  {q:"Hobbes: without government, life is:",o:["Perfect","Solitary, poor, nasty, brutish, short","Unchanged","Better"],c:1,e:"State of nature motivates social contracts."}]},
];

const ASSIGNMENTS=[
{id:"a1",title:"Ethics Paper 1",sub:"Utilitarianism Applied",type:"📝",due:7,pts:100,con:["util"],tip:"Apply felicific calculus to a real dilemma.",
  reallyAsking:"Take a real-world dilemma, apply Bentham/Mill's framework to it, and argue whether the utilitarian answer is morally satisfying or not.",
  demand:"Apply + Evaluate",demandIcon:"🔬",
  secretCare:"The instructor wants to see you USE the framework on a specific case, not just explain what utilitarianism is. They want analysis, not summary.",
  failModes:["Summarizing utilitarianism instead of applying it","Picking a dilemma that's too simple to analyze","Forgetting to address objections to the utilitarian answer","Confusing Bentham's view with Mill's refinement"],
  prepPath:["util"],evidence:"A specific real-world case, applied felicific calculus, at least one objection addressed",
  quickPrep:"Learn utilitarianism core + distinction, then practice one dilemma application. ~15 minutes."},
{id:"a2",title:"Week 3 Discussion",sub:"Trolley Problem",type:"💬",due:3,pts:25,con:["util","deont"],tip:"Show you understand BOTH sides.",
  reallyAsking:"Explain why the switch and footbridge cases produce different moral intuitions, using at least two ethical frameworks.",
  demand:"Compare + Explain",demandIcon:"⚖",
  secretCare:"They want to see you DISTINGUISH frameworks, not just describe the trolley problem. The scenario is the vehicle, not the destination.",
  failModes:["Just describing the trolley scenario without analysis","Only using one framework","Saying 'there's no right answer' without explaining WHY the tension exists","Missing the switch vs footbridge distinction"],
  prepPath:["util","deont"],evidence:"Switch vs footbridge distinction, two framework applications, engagement with classmates",
  quickPrep:"Review trolley problem border between util and deont. Practice the dilemma. ~10 minutes."},
{id:"a3",title:"Kantian Analysis",sub:"Categorical Imperative",type:"📝",due:14,pts:100,con:["deont","catimperative"],tip:"Apply both formulations to one issue.",
  reallyAsking:"Choose one moral issue and test it against BOTH formulations of the categorical imperative — universal law AND humanity formula.",
  demand:"Apply + Synthesize",demandIcon:"🔬",
  secretCare:"Using BOTH formulations is the key. Most students only use one. Showing how they complement each other demonstrates real understanding.",
  failModes:["Only applying one formulation","Picking an example that's too obvious","Confusing the categorical imperative with 'follow the rules'","Not explaining WHY universalization fails"],
  prepPath:["catimperative","deont"],evidence:"One issue, both formulations applied, explanation of why each test succeeds or fails",
  quickPrep:"Review both formulations of the categorical imperative, practice the corruption card. ~12 minutes."},
{id:"a4",title:"Week 5 Discussion",sub:"Relativism Debate",type:"💬",due:10,pts:25,con:["relativism"],tip:"Use 'can't condemn genocide' objection.",
  reallyAsking:"Take a position on whether moral relativism is defensible, and defend it against the strongest objection.",
  demand:"Defend + Critique",demandIcon:"🗡",
  secretCare:"They want you to engage with the STRONGEST version of relativism and its strongest objection, not just dismiss it as obviously wrong.",
  failModes:["Dismissing relativism without engaging its arguments","Confusing relativism with tolerance","Not addressing the 'can't condemn genocide' problem","Treating cultural sensitivity as proof of relativism"],
  prepPath:["relativism"],evidence:"Clear position, strongest objection addressed, distinction between relativism and tolerance",
  quickPrep:"Review relativism core + the tolerance trap. ~8 minutes."},
{id:"a5",title:"Midterm Quiz",sub:"Chapters 1-5",type:"❓",due:21,pts:50,con:["util","deont","virtue","catimperative","socialcontract"],tip:"Focus on DISTINCTIONS between theories.",
  reallyAsking:"Demonstrate you can tell the major ethical theories apart, apply them to scenarios, and identify which philosopher said what.",
  demand:"Distinguish + Recall",demandIcon:"🧠",
  secretCare:"Speed and precision. The quiz tests whether you can QUICKLY identify which framework applies. Slow understanding won't help — you need instant recognition.",
  failModes:["Confusing deontology with virtue ethics","Mixing up Bentham and Mill","Not knowing the categorical imperative formulations","Forgetting social contract specifics"],
  prepPath:["util","deont","virtue","catimperative","socialcontract"],evidence:"Quick recall, framework identification, philosopher attribution",
  quickPrep:"Distinction Gym for all pairs + Who Said It + 25 T/F rapid fire. ~30 minutes."},
{id:"a6",title:"Final Paper",sub:"Multi-Framework Case",type:"📝",due:42,pts:200,con:["util","deont","virtue","socialcontract"],tip:"Show where frameworks AGREE and DIVERGE.",
  reallyAsking:"Analyze ONE complex case through multiple ethical lenses, showing where they agree, where they diverge, and what that teaches us about ethics.",
  demand:"Synthesize + Evaluate",demandIcon:"🏗",
  secretCare:"Synthesis is the highest-order skill. They want to see you hold multiple frameworks in mind simultaneously and find the tension points between them.",
  failModes:["Treating each framework as a separate essay instead of comparing them","Picking a case that only one framework handles","Not finding points of agreement","Concluding 'they're all valid' without deeper analysis"],
  prepPath:["util","deont","virtue","socialcontract"],evidence:"One complex case, 3+ frameworks applied, agreement AND disagreement points, personal synthesis",
  quickPrep:"Full concept review + Distinction Gym for all pairs. ~45 minutes."},
];

// ═══ DISTINCTION DATA ═══
// ═══ READING CONTENT — textbook chapters with rich sections ═══
const READING=[
{id:"r1",module:"m1",title:"What Is Ethics?",subtitle:"Chapter 1 · pp. 1-18",type:"chapter",concepts:["util"],assignments:["a1"],
  sections:[
    {heading:"Why Study Ethics?",body:"Ethics is not about memorizing rules. It is the practice of reasoning carefully about what we owe each other, what kind of lives are worth living, and how we should act when our values conflict."}
    {heading:"Descriptive vs. Normative Ethics",body:"There is a critical distinction between describing what people believe (descriptive ethics) and arguing what people should believe (normative ethics)."}
    {heading:"The Major Frameworks",body:"This course covers three major ethical traditions, each offering a fundamentally different answer to the question 'What makes an action right?'"}
    {heading:"How to Read Philosophy",body:"Philosophical texts are dense by design. Every sentence carries weight. The key to reading philosophy is not speed but re-reading. Read a passage once for the gist."}
  ]},
{id:"r2",module:"m1",title:"Utilitarianism: Bentham & Mill",subtitle:"Chapter 2 · pp. 19-55",type:"chapter",concepts:["util"],assignments:["a1"],
  sections:[
    {heading:"The Utilitarian Revolution",body:"Before Bentham, most Western moral philosophy was grounded in religious authority or abstract reason. Bentham proposed something radical: morality should be based on measurable outcomes."}
    {heading:"The Felicific Calculus",body:"Bentham proposed that we could literally calculate the moral value of an action by measuring its pleasures and pains across seven dimensions: intensity, duration, certainty, propinquity (how soon), fec"}
    {heading:"Mill's Refinement",body:"John Stuart Mill inherited Bentham's framework but found it crude. His famous objection: 'It is better to be Socrates dissatisfied than a fool satisfied."}
    {heading:"Act vs. Rule Utilitarianism",body:"Act utilitarianism says: evaluate each individual action by its consequences. Rule utilitarianism says: follow rules that, if everyone followed them, would produce the best consequences overall."}
  ]}
];

// ═══ MARGIN INTELLIGENCE — annotations, whispers, popovers ═══
const MARGINS={
"r1:0":[
  {type:"hook",text:"This is the foundational framing for the entire course. Every assignment will reference back to this idea.",color:"#ffd700"},
  {type:"plain",text:'Plain English: Ethics = learning to argue about right and wrong using logic instead of gut feelings.',color:"#06d6a0"},
],
"r1:1":[
  {type:"confusion",text:"⚠ Students often confuse these two. 'Different cultures disagree' is a FACT. 'Therefore nobody is wrong' is a CLAIM that needs proof.",color:"#ff4466"},
  {type:"assignment",text:"📋 This distinction is critical for the Week 5 Discussion on Relativism.",color:"#fb923c"},
  {type:"border",text:"This is where descriptive ethics STOPS and normative ethics BEGINS. Everything after this line is philosophy, not sociology.",color:"#a78bfa"},
],
"r2:0":[
  {type:"hook",text:"This paragraph is the backbone of Assignment 1 (Ethics Paper). Understanding Bentham's revolution is essential for applying the framework.",color:"#ffd700"},
  {type:"oracle",text:"🏛 Kant would challenge this entire premise: morality based on measurable outcomes reduces humans to data points in a happiness equation.",color:"#a78bfa"},
],
"r2:2":[
  {type:"border",text:"This is where Bentham STOPS and Mill BEGINS. Bentham counts all pleasure equally.",color:"#a78bfa"},
  {type:"thesis",text:'★ "Who decides which pleasures are higher?" is one of the strongest objections to Mill. A paper that addresses this earns top marks.',color:"#ffd700"},
],
"r4:0":[
  {type:"plain",text:'Plain English: Instead of asking "what should I DO?" Aristotle asks "what kind of person should I BE?" — character first, actions follow.',color:"#06d6a0"},
  {type:"border",text:"This is where virtue ethics SEPARATES from both utilitarianism and deontology. Neither consequences nor rules — character.",color:"#a78bfa"},
],
};
...
// ═══ DISCUSSION THREADS — classroom conversations ═══
const DISCUSSIONS=[];

const QUALITY_META={};

// ═══ TRANSCRIPT DATA — time-based learning content ═══
const TRANSCRIPTS=[
{id:"t1",title:"Lecture 1: Why Ethics Matters",speaker:"Prof. Harrison",duration:2340,type:"lecture",concepts:["util"],assignments:["a1"],
  segments:[
    {id:"s1",label:"Opening",ts:0,lines:[
      {t:0,text:"Welcome everyone. Today we begin a journey that will fundamentally change how you think about right and wrong."},
      {t:8,text:"Before we define any frameworks, I want you to consider a question: have you ever done something you knew was wrong, and felt perfectly fine about it afterward?"},
      {t:18,text:"That dissonance — between what we believe and what we do — is exactly where ethics lives. Ethics isn't about having the right answers."},
      {t:30,text:"By the end of this course, you won't think the same way about moral decisions. And that's the point."},
    ]},
    {id:"s2",label:"What Is Ethics?",ts:42,lines:[
      {t:42,text:"So what IS ethics? Let me be precise. Ethics is the systematic study of what we ought to do — not what we happen to do, not what feels good, "},
      {t:55,text:"There's a crucial distinction here that trips up students every semester: descriptive versus normative ethics."},
      {t:63,text:"Descriptive ethics asks: what DO people believe? That's sociology. Normative ethics asks: what SHOULD people believe? That's philosophy. This course is normative."},
      {t:75,text:"When someone says 'different cultures have different values,' that's descriptive."},
      {t:90,text:"We'll come back to that leap when we study moral relativism. For now, just notice: describing what IS never automatically tells you what OUGHT to be."},
    ]},
  ]},
];

const DISTS=[
{a:"util",b:"deont",label:"Outcomes vs Duties",
  border:"Utilitarianism asks 'What produces the most good?' Deontology asks 'What rule should I follow regardless?'",
  trap:"Both claim to be about doing 'the right thing.' The difference is WHERE rightness lives — in results or in the act itself.",
  twins:"Both are systematic frameworks that try to give clear answers. Students group them together as 'the two main theories.'",
  enemy:"They directly conflict when following a rule produces bad outcomes. The trolley problem exists because of this conflict.",
  corruption:{original:"Actions are right because they produce good consequences.",swapped:"Actions are right because they follow moral duties.",concept:"util",answer:"swapped"},
  whichLessWrong:{q:"A utilitarian would say lying is:",a:"Sometimes right — if it produces more good",b:"Always wrong — it violates a universal principle",correct:"a",why:"B describes KANT's position. The trap is that 'always wrong' sounds more moral, so students pick it."},
  neighbor:{claim:"We should maximize happiness by following universal moral rules.",looks:"util",actually:"Neither — it fuses both frameworks. Utilitarianism doesn't care about rules; deontology doesn't optimize for happiness."}},
{a:"util",b:"virtue",label:"Calculating vs Becoming",
  border:"Utilitarianism calculates outcomes for each decision. Virtue ethics builds character that naturally makes good decisions.",
  trap:"Both want 'good outcomes' in some sense. But utilitarianism measures outcomes per-action; virtue ethics says good character produces good lives.",
  twins:"Both care about human wellbeing. Students think virtue ethics is just 'nicer utilitarianism.'",
  enemy:"A utilitarian might sacrifice personal character for maximum good. A virtue ethicist would say that's self-defeating.",
  corruption:{original:"The right action produces the greatest total good.",swapped:"The right action flows from a person of good character.",concept:"util",answer:"swapped"},
  whichLessWrong:{q:"What makes a person moral?",a:"Consistently producing good outcomes in every situation",b:"Having internalized virtues through years of practice",correct:"b",why:"A sounds right but describes a CALCULATOR, not a person. The trap: we conflate 'doing good' with 'being good.'"},
  neighbor:{claim:"We become better by repeatedly choosing the option with the best consequences.",looks:"virtue",actually:"Utilitarianism. Virtue ethics says we become better by practicing virtues, not by optimizing outcomes."}},
{a:"deont",b:"virtue",label:"Rules vs Character",
  border:"Deontology: follow the right rules. Virtue ethics: be the right person. Rules are external; character is internal.",
  trap:"Both reject pure outcome-calculation. Students think 'not utilitarian = same thing.'",
  twins:"Both believe some things matter independent of consequences.",
  enemy:"Deontology says a good person who breaks moral law is still wrong. Virtue ethics says rigid rule-following without wisdom is morally incomplete.",
  corruption:{original:"Act only on rules you could will everyone to follow.",swapped:"Act from the character traits a good person would have.",concept:"deont",answer:"swapped"},
  whichLessWrong:{q:"Kant would say a virtuous person who lies is:",a:"Still wrong — lying violates the categorical imperative",b:"Admirable — their good character justifies flexibility",correct:"a",why:"B is tempting because we LIKE flexible moral heroes. But Kant explicitly rejects this — duty overrides character."},
  neighbor:{claim:"A person of strong moral duty who habitually practices integrity.",looks:"Both",actually:"This SOUNDS like both, but duty (deontology) and habit (virtue) come from fundamentally different sources — reason vs practice."}}
];

const PH=[
{n:"Jeremy Bentham",t:"Utilitarianism",q:[
  {x:"The greatest happiness of the greatest number is the foundation of morals and legislation.",p:44,tg:["happiness","morality","good","greatest","foundation"]},
  {x:"Nature has placed mankind under the governance of two sovereign masters: pain and pleasure.",p:43,tg:["pain","pleasure","nature","human","feeling","governance"]},
  {x:"The question is not Can they reason? but Can they suffer?",p:47,tg:["suffering","rights","animals","empathy","reason"]},
]},
{n:"Immanuel Kant",t:"Deontology",q:[
  {x:"Act only according to that maxim whereby you can will it should become a universal law.",p:62,tg:["universal","law","action","rule","lying","duty","maxim","will"]},
  {x:"Treat humanity never merely as a means, but always also as an end.",p:64,tg:["humanity","dignity","means","ends","person","respect","use","tool"]},
  {x:"Two things fill the mind with admiration: the starry heavens above and the moral law within.",p:60,tg:["moral","wonder","reason","law","admiration","starry","heavens"]},
]},
{n:"Aristotle",t:"Virtue Ethics",q:[
  {x:"We are what we repeatedly do. Excellence is not an act, but a habit.",p:78,tg:["habit","excellence","practice","character","virtue","action","repeatedly"]},
  {x:"Virtue is a state of character concerned with choice, lying in a mean relative to us.",p:80,tg:["virtue","character","choice","mean","balance","moderate","state"]},
  {x:"It is the mark of an educated mind to entertain a thought without accepting it.",p:82,tg:["thought","education","mind","reason","open","educated","mark"]},
]},
{n:"John Stuart Mill",t:"Utilitarianism",q:[
  {x:"It is better to be Socrates dissatisfied than a fool satisfied.",p:51,tg:["pleasure","quality","higher","satisfaction","happiness","fool","socrates"]},
  {x:"Actions are right in proportion as they tend to promote happiness.",p:49,tg:["happiness","right","action","good","consequence","promote","proportion"]},
]},
{n:"Thomas Aquinas",t:"Natural Law",q:[
  {x:"The natural law is the rational creature's participation in the eternal law.",p:118,tg:["natural","law","reason","eternal","god","rational","creature"]},
  {x:"Good is to be done and pursued, and evil is to be avoided.",p:120,tg:["good","evil","action","moral","pursue","avoid","natural"]},
]},
{n:"John Rawls",t:"Social Contract",q:[
  {x:"Justice is the first virtue of social institutions, as truth is of systems of thought.",p:102,tg:["justice","society","institution","fairness","truth","virtue","first"]},
  {x:"No one knows his place in society — principles chosen behind a veil of ignorance.",p:104,tg:["veil","ignorance","fairness","position","society","equal","justice","place"]},
]},
];
...
const[cc,setCC]=useState(CD.map(c=>({...c,mastery:0})));
...
// MODULE & CHAPTER DATA — course structure mapped to textbook
const MODULES=[
  {id:"m1",title:"Module 1: Foundations of Ethics",ch:"Chapters 1-2",pages:"pp. 1-55",desc:"Introduction to ethical reasoning, major frameworks, and the role of philosophy in moral life.",
    concepts:["util"],textbook:[
      {title:"What Is Ethics?",pages:"1-18",summary:"Ethics as systematic moral reasoning. Descriptive vs normative ethics. Why study ethics?"},
      {title:"Utilitarianism: Bentham & Mill",pages:"19-55",summary:"The consequentialist tradition. Felicific calculus. Higher vs lower pleasures. Act vs rule distinction."},
    ]},
  {id:"m2",title:"Module 2: Deontological Ethics",ch:"Chapters 3-4",pages:"pp. 56-95",desc:"Kant's moral philosophy, the categorical imperative, and duty-based reasoning.",
    concepts:["deont","catimperative"],textbook:[
      {title:"Kant's Moral Theory",pages:"56-75",summary:"Good will. Duty vs inclination. The moral law as rational principle."},
      {title:"The Categorical Imperative",pages:"76-95",summary:"Universal law formula. Humanity formula. Perfect vs imperfect duties. Applications."},
    ]},
  {id:"m3",title:"Module 3: Virtue Ethics",ch:"Chapter 5",pages:"pp. 96-130",desc:"Aristotle's character-based ethics, the doctrine of the mean, and the good life.",
    concepts:["virtue","mean"],textbook:[
      {title:"Aristotle & Character",pages:"96-115",summary:"Virtues as habits. Practical wisdom. The role of community in moral development."},
      {title:"The Doctrine of the Mean",pages:"116-130",summary:"Virtue as balance. Courage, temperance, justice. Mean relative to us."},
    ]},
  {id:"m4",title:"Module 4: Challenges & Thought Experiments",ch:"Chapters 6-7",pages:"pp. 131-175",desc:"Classic challenges to ethical theories and how thought experiments reveal moral intuitions.",
    concepts:["expmachine","actrule"],textbook:[
      {title:"The Trolley Problem & Moral Psychology",pages:"131-155",summary:"Switch vs footbridge. What our reactions reveal. Dual-process moral reasoning."},
      {title:"Nozick & the Limits of Pleasure",pages:"156-175",summary:"Experience machine. Authenticity. Objections to hedonism. Act vs rule debate."},
    ]},
  {id:"m5",title:"Module 5: Social & Political Ethics",ch:"Chapters 8-9",pages:"pp. 176-220",desc:"Social contract theory, justice, relativism, and the foundations of political morality.",
    concepts:["socialcontract","relativism","naturallaw"],textbook:[
      {title:"The Social Contract Tradition",pages:"176-200",summary:"Hobbes, Locke, Rawls. State of nature. Veil of ignorance. Justice as fairness."},
      {title:"Relativism & Natural Law",pages:"201-220",summary:"Cultural relativism. The tolerance objection. Natural law as alternative. Aquinas."},
    ]},
];
