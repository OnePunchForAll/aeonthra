...
$script:GodModeRequiredDirs = @('lib','bin','docs','profiles/regular','profiles/mini-masters','profiles/baselines','profiles/adversarial','memory','queues/pending','queues/active','queues/done','queues/failed','queues/replay','queues/tournament','queues/adversarial','inbox/results','inbox/heartbeats','events','logs','traces','worktrees','arena/vendor','live','mission-control','journeys','schemas','safety','rules','hooks','tests/golden/missions','tests/replay','checkpoints','archive/ledgers','archive/corrupted','archive/snapshots','archive/proposals','archive/patches','archive/worktrees','archive/missions','archive/host-actions','host-actions','state','graphs','skills','config')
